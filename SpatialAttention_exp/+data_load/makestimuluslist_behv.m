% makestimuluslist_SNR_EEGv4_prac.m
% make stimulus list for practice version of the CRM test (EEG version 4)
% v2
% 20220308 new CRM: started improvement only for single talker %%%
% v3
% 20220322 adjusted masker length and various SNR %%%
% v4
% 20221022 for experiment v4 %%%
