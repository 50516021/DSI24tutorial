 function [stimulusTable] = makestimuluslist_SNR_EEGv4(sbjname)
...
numSph = 28; % speech amount (repeatation of the same situation(SP, SNR, Gen)) 
%!numSph should be a multiple of two times of numCol to use all the colors
%evenly! (thus, multiple of 8 for 4 colors)
%note: 
